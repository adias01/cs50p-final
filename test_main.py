...
from main import create_csv, age_stats, pre_mun_stats, month_stats


@pytest.fixture
def sample_txt(tmp_path):
    txt_file = tmp_path / "202304_newcomers.txt"
    content = (
        "f.aar;navn;adresse1;adresse2;postnr;poststed;flyttet;tidl.knr;tidl.k\n"
        "2020;Kari Nordmann;Street 1;;1000;CityA;2023-04-01;3413;Mun1\n"
        "2008;Ola Nordmann;Street 2;;1001;CityB;2023-04-02;0301;Capital\n"
        "1985;Sarah Sahara;Street 3;;1002;CityC;2023-04-03;3420;Mun4\n"
        "1970;John Smith;Street 4;;1003;CityD;2023-04-04;3411;Mun2\n"
        "1955;Liudmyla Kharkov;Street 5;;1004;CityE;2023-04-05;3412;Mun3\n"
    )
...
def test_create_csv_creates_valid_csv(sample_txt):
    ...
    with open(csv_file, newline="") as f:
        ...
        assert len(reader) == 5
        assert reader[0]["navn"] == "Kari Nordmann"
